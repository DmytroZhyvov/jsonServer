...
describe('User can', () => {
    ...
    it('receive 10 first posts via GET', () => {
    ...
    it('receive posts id=55 and id=60 via GET', () => {
    ...
    it('not patch a not-existing post via PATCH', () => {
        cy.request({
            method: 'PATCH',
            url: 'posts/300',
            body: post,
    ...
    it('not delete a not-existing post via DELETE', () => {
        cy.request({
            method: 'DELETE',
            url: 'posts/300',
            body: post,
